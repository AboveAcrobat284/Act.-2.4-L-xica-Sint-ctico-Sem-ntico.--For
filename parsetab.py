...
_lr_productions = [
  ...
  ('statement -> PR ( INT ID = NUM ; ID LE NUM ; ID PLUSPLUS ) { statement_block }','statement',17,'p_statement_for','lexi.py',62),
  ('statement_block -> statement','statement_block',1,'p_statement_block','lexi.py',66),
  ('statement_block -> statement statement_block','statement_block',2,'p_statement_block','lexi.py',67),
  ('statement -> SYSTEM . OUT . PRINTLN ( STRING ) ;','statement',9,'p_statement_print','lexi.py',71),
]
